...
return(
    <div className="app">
        <div className="inner lazyload" data-bg="https://cdn01.alison-static.net/public/html/site/img/homepage/app-mobile-bg.png">
            <div className="app__intro app-intro">
                ...
                <div className="app__nav">
                    <Link target="_blank" to="#"><img width="176" height="50" className="lazyload" src="https://cdn01.alison-static.net/public/html/site/img/homepage/android.png" alt="Download on Google Play" title="Download the Fhorge app on Android" /></Link>
                    <Link
