        ...
        <div class="goals goals--upper">
            <div class="inner">
                ...
                <div class="goals__container">
                    <Link to="/user/questionnaire?edit=false&goal=1" class="goal lazyload" data-bg="https://cdn01.alison-static.net/public/html/site/img/homepage/flag.svg"> I want to <br /><span>upskill</span>
