        ...
        <div className="intro build-intro">
            ...
            <div className="steps">
                <Link to="#" title="Fhorge's Workplace Personality Assessment" className="stepp">
                    ...
                    <div className="step__desc"><span className="hide-on-mobile"><span className="bold">1. </span> Discover your strengths with <span className="bold">Alison's Workplace Personality Assessment</span><span className="icon-carousel-arrow"></span></span><span className="hideit-on-desktop bold"
                            style={{ display: "none" }}> Discover your strengths and weaknesses <span className="icon-filter_up"></span></span>
                    </div>
                </Link>
                <Link to="https://Fhorge.com/careers" title="Find your perfect career." className="stepp">
                    <div className="step__img">
                ...
                <Link to="https://alison.com/resume-builder" title="Create a job-winning resumé" className="stepp">
                    <div className="step__img">
                    <img src="https://cdn01.alison-static.net/public/html/site/img/homepage/step-3-mobile.svg" alt="" />
                    </div>
                    <div className="step__desc"><span className="hide-on-mobile"><span className="bold">3. </span> Create a <span className="bold">job-winning Resumé</span> with Alison’s Resumé Builder and apply for your dream job <span className="icon-carousel-arrow"></span></span><span className="hideit-on-desktop bold"
            ...
            <div className="inner">
                <div class="path">
                    <div className="path__intro">
                        ...
                        </p><Link to="https://fhorge.com/psychometric-test/personality" title="Start Your Free Personality Assessment" className="but"> Start Your Free Personality Assessment </Link>
                        </div>
                ...
                <div className="path path--right">
                    <div className="path__intro">
                        <h2>Fast Track Your Career <br></br>With Alison's Career Guide</h2><img style={{display: "none"}}  width="449" height="344" className="lazyload" data-srcset="https://cdn01.alison-static.net/public/html/site/img/homepage/path-2.png, /html/site/img/homepage/path-2@2x.png 2x"
                            data-src="https://cdn01.alison-static.net/public/html/site/img/homepage/path-1.png" title="Fast Track Your Career With Alison's Career Guide" alt="Fast Track Your Career With Alison's Career Guide" />
                        ...
                        </p><Link to="https://fhorge.com/careers" title="Discover Careers Now" className="but"> Discover Careers Now </Link>
                        </div>
                    <div className="path__img"><img width="449" height="344" className="lazyload" data-srcset="https://cdn01.alison-static.net/public/html/site/img/homepage/path-2.png, /html/site/img/homepage/path-2@2x.png 2x" data-src="https://cdn01.alison-static.net/public/html/site/img/homepage/path-1.png"
                            title="Fast Track Your Career With Alison's Career Guide" alt="Fast Track Your Career With Alison's Career Guide" /></div>
                </div>
                <div className="path">
                    <div className="path__intro">
                        ...
                        <p class="sub"> Create a <span class="bold">job-winning Resumé</span> with Alison’s Resumé Builder and apply for your dream job </p><Link to="https://alison.com/cv?source=profile" title="Create My Professional Resumé" className="but"> Create My Professional Resumé </Link>
                        </div>
                    <div
